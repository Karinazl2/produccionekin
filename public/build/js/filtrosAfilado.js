    ...
    function mostrarOrdenes(ordenes) {
        ...
        if (ordenes.length > 0) {
            ordenes.forEach(orden => {
                const { numero_orden, descripcion_orden, hora_orden, fecha_orden, prioridad_orden, nombre_maquina, referencia_cliente, nombre_cliente, nombre_operador, apellido_operador, nombre_usuario, apellido_usuario, orden_id } = orden;
                ...
                row.innerHTML = `
                   ...
                   <td>
                       ...
                       <a href="/busquedaafilado/actualizar?id=${orden_id}" class="boton-verde-block-1">Actualizar</a>
                   </td>
               `;
