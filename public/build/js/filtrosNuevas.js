    ...
    function mostrarOrdenes(ordenes) {
         ...
         if(ordenes.length > 0){
            ordenes.forEach(orden => {
                const { numero_orden, descripcion_orden, hora_orden, fecha_orden, prioridad_orden, nombre_area, nombre_maquina, referencia_cliente, nombre_cliente, nombre_operador, apellido_operador, nombre_usuario, apellido_usuario, 
                id } = orden;
