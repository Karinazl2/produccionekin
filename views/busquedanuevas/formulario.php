<fieldset>
    ...
    <input type="text" id="orden" name="nuevas_ordenes[orden]" placeholder="Número de Orden" value="<?php echo s($nuevas_ordenes->orden);?>">
    ...
    <input type="text" id="prioridad" name="nuevas_ordenes[prioridad]" placeholder="Prioridad"
