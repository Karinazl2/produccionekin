...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong> Has Registrado Correctamente tu cuenta en el Administrador de producción de Ekin; pero es necesario confirmarla</p>";
